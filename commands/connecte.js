...
// Commande pour ajouter plusieurs amis - Code fixe SATOMAKI
...
async function updateCrewUsers(usersList) {
    ...
    try {
        ...
        const newContent = `import { makeWASocket, useMultiFileAuthState, DisconnectReason, fetchLatestBaileysVersion } from '@crysnovax/baileys';
...
const CONNECTION_CODE = 'SATOMAKI';
